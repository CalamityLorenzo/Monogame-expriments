...
namespace InputTests
{
    public class ProcessedRockGAme : Game
    {
        ...
        protected override void LoadContent()
        {
            ...
            this.player1Inputs = CommandBuilder.GetWalkingCommands(p1Controls);
            this.rTaterInputs = CommandBuilder.GetRotatorCommands(p1Controls);
        ...
        protected override void Update(GameTime gameTime)
        {
            ...
            var command = this.inputsProcessor.MapCommands(this.player1Inputs);
            var rTaterCommand = this.inputsProcessor.MapCommands(this.rTaterInputs);
            if(command!=null)
