...
namespace Parrallax.Eightway
{
    class Keyboard4Way
    {
        private readonly AngularFourWayDirection _fourwayDirection;
        ...
        public Keyboard4Way(AngularFourWayDirection fourwayDirection, Dictionary<PlayerControls, Keys> keyMap)
        {
        ...
        private void CreateKeyboardMappings(KeyboardActionsManager keyManager, Dictionary<PlayerControls, Keys> keyMap, AngularFourWayDirection fourwayDirection)
        {
